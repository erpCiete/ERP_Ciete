    ...
    return (
        ...
        >
            ...
            <div className="mx-auto max-w-7xl space-y-5 px-6 py-8">
                ...
                {/* Filtros */}
                <div className="flex flex-wrap items-end gap-3 rounded-[12px] border border-border bg-surface p-4">
                            ...
                            {rows.length === 0 ? (
                                ...
                                rows.map((user) => (
                                    <tr key={user.id_usuario} className="transition hover:bg-surface-2">
                                        ...
                                        <td className="px-4 py-3 text-sm text-text-muted">{user.nombre_usuario}</td>
