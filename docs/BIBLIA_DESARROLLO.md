...
El ERP CIETE no se implementa desde documentos antiguos si contradicen la fuente de verdad vigente. Los planes de sprint, bitacoras, manuales anteriores y contratos API antiguos son contexto historico.
...
Los documentos antiguos se conservan para trazabilidad. Si contradicen esta Biblia compactada o la fuente de verdad, prevalece:

1. `docs/02_CLIENTE/DECISIONES_FUNCIONALES_ERP_CIETE_2026-05-03.md`
2. `docs/02_CLIENTE/tareasComparar.md`
3. `docs/03_API_ERP/Trabajos_API_Contract.md`
4. Esta Biblia
