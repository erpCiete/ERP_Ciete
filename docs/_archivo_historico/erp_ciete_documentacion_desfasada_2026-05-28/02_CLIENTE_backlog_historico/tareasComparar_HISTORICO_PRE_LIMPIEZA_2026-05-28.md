...
## 2026-05-27 — Creado plan técnico de nueva versión ERP CIETE

Estado: documentación creada, sin implementación todavía.
...
- plan de ejecución de 8 días
- backlog P0/P1/P2
- checklist final

No se modifica porcentaje de avance porque todavía no hay implementación ni criterios funcionales validados.

Siguiente paso:

- revisar el documento con Pablo
- ajustar el plan si hace falta
- después empezar por la primera tarea aprobada

## 2026-05-27 — Refinado documental del plan técnico ERP CIETE

Estado: documentación refinada, sin implementación todavía.
...
- se añade la sección `10.1 Orden real de ejecución aprobado` para reorganizar el plan en bloques funcionales ejecutables sin alterar el plan original de 8 días

No se modifica porcentaje de avance porque sigue sin haber implementación ni validación funcional nueva.

## 2026-05-28 — Creado estado funcional de nueva versión ERP CIETE

Estado: documentación de control creada, sin nueva implementación.
...
- bloques A-G,
- checklist funcional,
- documentación posiblemente desfasada,
- riesgos antes de seguir.

No modificar porcentaje de avance salvo que haya criterios funcionales nuevos validados. Como este paso es documental, no subir porcentaje.

## 2026-05-27 — Bloque A ejecutado: Trabajos como centro operativo
...
- se refuerza la lectura visual del pedido principal dentro de `Trabajos`
- los trabajos sin pedido muestran ahora `Sin pedido` de forma explícita
- se añade un placeholder discreto para la futura acción “Crear pedido desde trabajo”, sin lógica funcional todavía
- se renombra la cabecera visual de la columna a `Pedido principal`
- se ajusta la descripción de la pantalla de `Trabajos` y se añade una nota compacta para reforzar que es la vista operativa principal diaria

Validaciones ejecutadas:

- revisión estática de compatibilidad con inline edit y control de conflicto por campo en `TrabajosExcelView`
- `npm run build`

Criterios cumplidos:

- `Trabajos` queda mejor identificado como pantalla principal diaria
- trabajos con pedido y sin pedido se distinguen con mayor claridad
- el pedido principal sigue visible cuando existe
- queda preparado un hueco visual discreto para el futuro flujo del Bloque B
- no se toca base de datos, lógica de pedidos, decimales, exportación Moeve ni facturación avanzada

Riesgos detectados:

- falta validación manual final en navegador para confirmar UX por rol/contexto y lectura exacta en modo Ciete Excel
- `Pedidos` sigue accesible como módulo separado; en este bloque se reduce la dependencia operativa desde la tabla, pero no se reestructura todavía su papel funcional
...
No se modifica porcentaje de avance porque no hay validación funcional nueva ni implementación adicional en este paso.

## 2026-05-28 — Limpieza documental y mapa de autoridad

Estado: documentación reorganizada, sin implementación funcional.
...
- revisión de documentación viva/histórica,
- marcado o movimiento de documentación desfasada,
- actualización de índices README,
- actualización de Biblia de desarrollo,
- preparación para plan de ejecución corto basado en reunión 2026-05-19.

No modificar porcentaje global porque no hay implementación funcional nueva.
