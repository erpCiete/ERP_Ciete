...
> No usar como fuente principal de implementación.
> Contrastar siempre con `listado_exhaustivo_reunion_cesar_amaya_ciete_2026-05-19.md`, `estado_funcional_nueva_version_erp_ciete_2026-05-28.md`, `plan_8_dias_nueva_version_erp_ciete.md` y el código real.

Estado: sintesis interpretativa secundaria historica de la reunion y de las notas funcionales posteriores.
