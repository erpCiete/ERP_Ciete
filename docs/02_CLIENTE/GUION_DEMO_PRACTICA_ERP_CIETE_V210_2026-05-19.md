...
*[Hablar mientras se muestra la pantalla de inicio del ERP]*
...
*[No hace falta mostrar pantalla; es presentación verbal]*
...
*[Mostrar brevemente la pantalla de inicio y el selector de contexto]*
...
*[Mostrar el listado de Trabajos en Ciete Excel]*
...
*[Ir mostrando según cada perfil]*
...
*[Mostrar el flujo de forma lineal con un ejemplo real]*
...
*[Mostrar las dos vistas del mismo listado de trabajos]*
...
*[Pantalla de inicio del ERP visible]*
...
*ERP CIETE v2.1.0 — Guion de demostración — Mayo 2026*
