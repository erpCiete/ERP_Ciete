...
class PermisosSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $rows = [
            ...
            ['id_permiso' => 4, 'nombre' => 'Ver proyectos', 'slug' => 'proyectos.ver', 'descripcion' => 'Consulta de proyectos'],
            ['id_permiso' => 5, 'nombre' => 'Crear proyectos', 'slug' => 'proyectos.crear', 'descripcion' => 'Creacion de proyectos'],
            ['id_permiso' => 6, 'nombre' => 'Editar proyectos', 'slug' => 'proyectos.editar', 'descripcion' => 'Edicion de proyectos'],
            ['id_permiso' => 7, 'nombre' => 'Cerrar proyectos', 'slug' => 'proyectos.cerrar', 'descripcion' => 'Cierre de proyectos'],
            ['id_permiso' => 8, 'nombre' => 'Reabrir proyectos', 'slug' => 'proyectos.reabrir', 'descripcion' => 'Reapertura de proyectos'],
            ['id_permiso' => 9, 'nombre' => 'Editar proyectos cerrados', 'slug' => 'proyectos_cerrados.editar', 'descripcion' => 'Edicion de proyectos cerrados'],
            ['id_permiso' => 10, 'nombre' => 'Reabrir proyectos cerrados', 'slug' => 'proyectos_cerrados.reabrir', 'descripcion' => 'Reapertura de proyectos cerrados'],
