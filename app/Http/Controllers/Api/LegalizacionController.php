...
class LegalizacionController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Listado de legalizaciones obtenido (Stub)',
            'data'    => [],
            'meta'    => [
    ...
    /**
     * Crear una nueva legalización.
     */
    public function store(Request $request): JsonResponse
    {
        // TODO: Validar permisos (RBAC) para creación.
        // TODO: Validar payload y asegurar que la legalización se asigna al cliente correcto.
        return response()->json([
            'success' => true,
            'message' => 'Legalización creada exitosamente (Stub)',
            'data'    => null,
        ], 201);
    }

    /**
     * Detalle de una legalización específica.
     */
    public function show(string $id): JsonResponse
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Detalle de la legalización (Stub)',
            'data'    => ['id' => $id],
        ]);
    }

    /**
     * Actualizar una legalización existente.
     */
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Legalización actualizada exitosamente (Stub)',
            'data'    => ['id' => $id],
        ]);
    }
